...
<head>
	<meta charset="utf-8" />
	<title>SIITec: Agregar Usuario</title>
			...
			<div class="span12">
                    ...
                    <div class="row-fluid">
						<div class="span12">
							<h2 class="welcome">
								...
								<span class="text-info">Agregar Usuario</span>
							</h2>
						</div>
					</div>
					<div class="row-fluid">
                        ...
                        <form action= "registraUsuario.php" method="post" autocomplete="on"/>
							...
							<fieldset>
							  ...
							  <div class="control-group">
							    <div class="controls">
								  <input id="cajaNombre" class="input-large" type="text" name="cajaNombre" value= "<?php echo $valorNombre; ?>" pattern="[a-z| A-Z | | áéíóúñÁÉÍÓÚÑ]*$"/>
                                      </div>
									</div>

									<div class="control-group">Apellido Paterno
									  <div class="controls">
              <input id="cajaApellidoPat" class="input-large" type="text" name="cajaApellidoPat" value="<?php echo $apellidoPaterno; ?>" pattern="[a-z| A-Z | | áéíóúñÁÉÍÓÚÑ]*$"/>
            </div>
									</div>

									<div class="control-group">Apellido Materno
									 <div class="controls">
              <input id="cajaApellidoMat" class="input-large" type="text" name="cajaApellidoMat" value="<?php echo $apellidoMaterno; ?>" pattern="[a-z| A-Z | | áéíóúñÁÉÍÓÚÑ]*$"/>
            </div>
									</div>

									<div class="control-group">Contraseña 
									 <div class="controls">
              <input id="cajaContrasena" class="input-large" type="text" name="cajaContrasena" value="<?php echo $valorPassword; ?>" pattern="[a-z| A-Z | | áéíóúñÁÉÍÓÚÑ]*$"/>
            </div>
									  <div class="controls controls-row"></div>
									</div>

									<div class="hr"></div>
									<div class="control-group">Área
									  <div class="controls">
              <select id="cajaArea" name="cajaArea">
	            ...
	            Planeación y Vinculación	
									...
									<div class="control-group">Pregunta de seguridad
									  <div class="controls">
              <select id="seleccionaPregunta" name="seleccionaPregunta">
	            ...
	            ¿Cuál es el nombre de tu mejor amigo?	
									...
									<div class="control-group">Respuesta
									<div class="controls">
              <input id="cajaRespuesta" class="input-large" type="text" name="cajaRespuesta" value="<?php echo $valorRespuesta; ?>" pattern="[a-z| A-Z | | áéíóúñÁÉÍÓÚÑ]*$"/>
            </div>
										<div class="controls controls-row"></div>
										<div class="controls controls-row"></div>
									</div>
