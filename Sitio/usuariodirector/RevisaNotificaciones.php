...
<head>
	...
	<meta charset="utf-8" />
	<title>SIITec: Revisa Notificaciones</title>
				...
				<div class="container-fluid content-wrapper">
					...
					<div class="row-fluid">
						<div class="span12">
							<h2 class="welcome">
								Usuario :
								<span class="text-info"><?php echo $usuario; ?></span>
							Área :
							<span class="text-info"><?php echo $area;?></span> Fecha Límite :
							<span class="text-info"><?php echo $fechaLimite;?></span></h2>
						</div>
					</div>
<div class="squiggly-border"></div>
					<div class="row-fluid">
					  <h4 class="welcome">
                                ...
                                <h4 class="welcome">
								Área :
								<span class="text-info"><?php echo $area; ?></span>
                                &nbsp;
                                &nbsp;
                                 <h4 class="welcome">
								Asunto :
								<span class="text-info"><?php echo $asunto; ?></span>
                                &nbsp;
                                &nbsp;
                                <h4 class="welcome">
								Fecha del Documento :
								<span class="text-info"><?php echo $fechaDocumento; ?></span>
                                &nbsp;
                                &nbsp;
                                <h4 class="welcome">
								Dependencia :
								<span class="text-info"><?php echo $dependencia; ?></span>
                                &nbsp;
                                &nbsp;
                                <h4 class="welcome">
								Remitente :
								<span class="text-info"><?php echo $remitente; ?></span>
                                &nbsp;
                                &nbsp;
                                 <h4 class="welcome">
								Descripción :
								<span class="text-info"><?php echo $descripcion; ?></span>
        ...
        <form method="post" action="decideRespuesta.php?idDocumento=<?php echo $idDocumento;?>">
     
		<textarea class="span10"   name="valores" placeholder="Escribe un comentario..." rows=5></textarea>
<style>
textarea.span10
{
resize:none;
             ...
             <input type="submit" class="btn btn-success" value="Liberar" name="si"> 
             
              <input type="submit" class="btn btn-danger" value="Rechazar" name="no"> 
           </form>
...
<footer class="black-gradient">
	...
	<div class="square-turtle pull-left">
		<p>
			...
			<a href="http://www.itszas.edu.mx/nueva/" target="_blank">SYSTeam</a>
		</p>
	</div>
</footer>
<!-- Javascript -->
