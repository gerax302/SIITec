...
<body id="body-index">
	...
	<div class="container-fluid main-container">
				...
				<div class="container-fluid content-wrapper">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							Área :
							<span class="text-info"><?php echo $area;?></span> Fecha Limite :
		...
		<textarea class="span10"   name="valores" placeholder="Escribe un comentario..." rows=5><?php echo $comentario;?></textarea>
<style>
textarea.span10
{
resize:none;
             ...
             <input type="submit" class="btn btn-success" value="Aceptar" name="si"> 
             
              <input type="submit" class="btn btn-danger" value="Reenviar" name="no"> 
           </form>
