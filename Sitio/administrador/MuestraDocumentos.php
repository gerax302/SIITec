...
<head>
<meta charset="utf-8" />
<title>SIITec: Mostrar Documentos</title>
    ...
    <div class="span12">
						...
						<li class="accordion" id="navigation-components">
							...
							<div id="collapse2" class="accordion-body collapse">
								<ul class="nav nav-stacked submenu">
									...
									<li>
										<a href="ConsultadeDocumentos.php">
											<span class="box">
												<i class="radmin-icon radmin-file"></i>
											</span>
											<span class="hidden-tablet hidden-phone">Documentos</span>
      ...
      <div class="container-fluid content-wrapper">
        ...
        <div class="row-fluid">
						<div class="span12">
						<h2 class="welcome">
				<span class="text-info">Documentos Registrados</span></h2>            <div class="squiggly-border"></div></h2>
				  </div>
		  </div>
          ...
          <div class="hr"></div>
            ...
            <thead>
              <tr>
                ...
                <th width="8%"><div align="center">Modificar</div></th>
                <th width="9%"><div align="center">Eliminar</div></th>
                
              </tr>
<?php
require_once("conexion.php");
$consulta = "select idDocumento, tipoDocumento, fechaDelDocumento, fechaDeRecepcion, fechaDeAsignacion, fechaLimite, folioDocumento, formatoDelDocumento, descripcion, estatus , idRemit,nombreRemit,nombreDepend,area, idUsuario from Documento";
$res=mysql_query($consulta, $con);
$i=0;
...
?>
            ...
            <tbody>
              <tr>
			    ...
			    <td align="center" ><p>  
				     <a href="MensajeEliminaDoc.php?id=<?php echo $Id ?> "> <img src="pic/eliminar.png" width="95" height="32"> </a> 
				 </p></td>
              </tr>
              <tr>
<?php
