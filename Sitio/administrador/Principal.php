...
.estilo2 {
	...
	<meta name="description" content="Página principal de inicio de sesión" />
    ...
    #body-index .container-fluid.main-container .row-fluid .span12 .container-fluid.content-wrapper .table.table-index thead tr th div {
	color: #003300;
}
    </style>
	...
	<div class="container-fluid main-container">
       ...
       <!-- AQUI ES LIMITE PPAL D NOTIFICACIONES -->
								...
								<ul class="nav nav-stacked submenu">
									<li>
										<a href="grid.html">
                                            ...
                                            <span class="hidden-tablet hidden-phone">	Por Gráficas</span>
                                      </a>
									</li>
									<li>
										<a href="icons.html">
											...
											<span class="hidden-tablet hidden-phone">Por Documentos</span>
										</a>
								</ul>
							</div>
						</li>
			  ...
			  <div class="container-fluid content-wrapper">
					...
					<div class="row-fluid">
						<div class="span12">
							<h2 align="left" class="welcome">Bienvenid@ <span class="text-info"><?php
	echo ($_SESSION['nombresesion']);
?></span>        <div class="squiggly-border"></div></h2>
						</div>
					</div>
					...
					<table class="table table-striped table-bordered table-radmin">
								<thead>
									<tr>
                                        ...
                                        <th width="14%"><div align="center">Fecha de Modicación</div></th>
                                        <th width="11%"><div align="center">Hora</div></th>
                                        <th width="11%"><div align="center">Asunto</div></th>
                                        <th width="14%"><div align="center">Estatus</div></th>
                                        <th width="12%"><div align="center">Usuario</div></th>
                                        <th width="15%"><div align="center">Área</div></th>
                                        <th width="17%"><div align="center">No. Documento</div></th>
								...
								<tbody>
									<tr>
										<td class="numbers"><p align="center">
     									<label> <?php echo $row['idBitacora']; ?> </label>
   										</p></td>
                                        
										<td class="text"><p align="center">
      									<label> <?php echo $row['fechaDeModificacion']; ?> </label>
									    </p></td>
